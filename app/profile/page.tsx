      ...
      <div className={styless.base}>
        <div className={styless.div_right}>
          ...
          >
            ...
            <Image
              src={`/icon/${
                selectedComponent === "lastReserv" ? selectedIcon : defaultIcon
              }`}
              alt=""
              width={32}
              height={32}
          ...
          >
            <p
              ...
              style={{
                color:
                  selectedComponent === "favorite" ? selectedColor : "#393939",
              }}
            >
              علاقه مندی ها
            </p>
          ...
          >
            ...
            <Image
              src={`/icon/${
                selectedComponent === "transaction" ? selectedIcon : defaultIcon
              }`}
              alt=""
              width={32}
              height={32}
          ...
          >
            <p
              ...
              style={{
                color:
                  selectedComponent === "question" ? selectedColor : "#393939",
              }}
            >
              درخواست پشتیبانی
            </p>
